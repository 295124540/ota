...
<script type="text/javascript" src="jsapi/otaapi.js"></script>
...
<div class="wraper">
	<div id="page-tabs">
		<ul>
			<li class="selected">
				<div></div>
				<a href="index.php">琼中OTA项目-接口文档<script type="text/javascript">bxsAPI.ver()</script></a>
			</li>
			<li>
				<div></div>
