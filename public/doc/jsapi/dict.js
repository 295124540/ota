...
bxsAPI.execFieldDict = function(data){
    ...
    for (var i=0;i<data.length;i++){
        ...
        new Element("div",{"class":"apih3"}).inject(apibox).set("html","&nbsp;&nbsp;<over>"+(i+1)+".&nbsp;&nbsp;</over>"+table['Name']+"<over style=\"font-weight: normal;margin: 10px\">"+table['Comment']+"</over><span class=\"rows\">"+table['Rows']+"条记录</span>");
