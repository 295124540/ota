<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\xampp\htdocs\ota\public/../application/admin\view\user\child.html";i:1495504083;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1500087413;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="body" class="body page_user">
    ...
    <div class="title_tab">
        <ul class="tab_navs title_tab">
            <li class="tab_nav first js_top  selected"><a href="/admin/user/child" id="reloadTop">书童列表</a></li>
            <li class="tab_nav js_top"><a href="/admin/user/addChild">添加书童</a></li>
        </ul>
    </div>
</div>
<div class="main_bd">
    <table class="city_list">
        ...
        <tr>
            ...
            <td>普通管理员</td>
            <td>
                <a class="btn btn_primary" href="/admin/user/updChild/id/<?php echo $x['id']; ?>">修改</a>
                <a class="btn" href="/admin/user/delete/id/<?php echo $x['id']; ?>">删除</a>
            </td>
        </tr>
