<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\xampp\htdocs\ota\public/../application/admin\view\book\index.html";i:1496366000;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1497322955;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="title_tab">
        <ul class="tab_navs title_tab">
            <li class="tab_nav first js_top  selected"><a href="javascript:void(0);" id="reloadTop">全部书籍</a></li>
            <li class="tab_nav js_top"><a href="/admin/book/create" id="blackTop">书籍入库</a></li>
            <li class="tab_nav js_top "><a href="javascript:;" >已租出</a></li>
        </ul>
    </div>
</div>
<div class="main_bd">
    <table class="city_list">
        ...
        <tr>
            <td><?php echo $x['id']; ?></td>
            <td><img width="100px" height="150px" src="<?php echo $x['model']['cover_img']; ?>"></td>
            <td><?php echo $x['model']['name']; ?></td>
            <td><?php echo $x['model']['auther']; ?></td>
            <td><?php echo $x['model']['intro']; ?></td>
            <td>
                <?php switch($x['status']): case "0": ?><span style="color: #ff5500">未上架</span><?php break; case "1": ?><span style="color: #4FAB1C">已上架</span><?php break; case "2": ?>已出租<?php break; default: endswitch; ?>
            </td>
            <td><img width="100px" src="/admin/book/qrcode/id/<?php echo $x['id']; ?>"></td>
            <td>
                <button class="btn btn_primary" onclick="putaway('<?php echo $x['id']; ?>')">上架</button>
                <a class="btn btn_primary" href="/admin/book/edit/id/<?php echo $x['id']; ?>">修改</a>
                <a class="btn" href="/admin/book/delete/id/<?php echo $x['id']; ?>">删除</a>
            </td>
        </tr>
