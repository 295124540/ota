<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\xampp\htdocs\ota\public/../application/admin\view\book_house\index.html";i:1498210150;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1500091511;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="body" class="body page_user">
    ...
    <div class="title_tab">
        <ul class="tab_navs title_tab">
            <li class="tab_nav first js_top  selected"><a href="javascript:void(0);" id="reloadTop">全部书屋</a></li>
            <li class="tab_nav js_top"><a href="/admin/book_house/create" id="blackTop">添加书屋</a></li>
...
<div class="main_bd">
    <table class="city_list">
        ...
        <tr>
            ...
            <td><?php echo $x['intro']; ?></td>
            <td>小童仙</td>
            <td>
                <a class="btn btn_primary" href="/admin/book_house/edit/id/<?php echo $x['id']; ?>">修改</a>
                <a class="btn" href="javascript:alert('你无权限哦！');">删除</a>
            </td>
        </tr>
