<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\xampp\htdocs\ota\public/../application/admin\view\book\houselist.html";i:1495096645;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1495418741;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="col_side">
                <div class="menu_box" id="menuBar">
                    ...
                    <dl class="menu ">
                        ...
                        <dd class="menu_item "><a href="#">书库管理</a></dd>
                        <dd class="menu_item "><a href="#">租书记录</a></dd>
                        <dd class="menu_item "><a href="#">捐书管理</a></dd>
                    </dl>
    ...
    <div class="title_tab">
        <ul class="tab_navs title_tab">
            ...
            <li class="tab_nav js_top"><a href="/admin/book/addHouse" id="blackTop">添加书屋</a></li>
        </ul>
    </div>
</div>
<div class="main_bd">
