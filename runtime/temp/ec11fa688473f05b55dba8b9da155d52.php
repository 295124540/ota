<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\xampp\htdocs\ota\public/../application/admin\view\book\edit.html";i:1495438735;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1495502069;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="title_tab">
        <ul class="tab_navs title_tab">
            ...
            <li class="tab_nav js_top selected"><a href="javascript:;" id="blackTop">书籍入库</a></li>
            <li class="tab_nav js_top "><a href="javascript:;" >已上架</a></li>
        </ul>
    </div>
</div>
<div class="main_bd">
    ...
    <form action="/admin/book/save" enctype="multipart/form-data" method="post" class=" form goods_form goods_add_form">
        ...
        <fieldset>
            ...
            <div class="form_group">
                <label>书籍编码</label><input  name="encoding"  type="text" value="<?php echo $model['encoding']; ?>" maxlength="15" />
            </div>
            <div class="form_group">
                <label>书名</label><input  name="name"  type="text" value="<?php echo $model['name']; ?>" maxlength="15" />
            </div>

            <div class="form_group">
                <label>作者</label><input  name="auther" type="text" value="<?php echo $model['auther']; ?>" maxlength="15" />
            </div>

            <div class="form_group">
                <label>出版社</label><input  name="publisher" type="text" value="<?php echo $model['publisher']; ?>" maxlength="15" />
            </div>
        ...
        <fieldset>
            ...
            <div class="goods_desc_box form_group">
                <label>详细介绍</label>
                <script class="ueditor" id="container" name="intro" type="text/plain"><?php echo $model['intro']; ?></script>
