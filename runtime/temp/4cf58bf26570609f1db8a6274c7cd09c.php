<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\xampp\htdocs\ota\public/../application/admin\view\book_house\edit.html";i:1495433155;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1495444214;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="main_bd">
    ...
    <form action="/admin/book_house/update/id/<?php echo $model['id']; ?>" enctype="multipart/form-data" method="post" class=" form goods_form goods_add_form">
        ...
        <fieldset>
            ...
            <div class="form_group">
                <label>书屋名称</label><input  name="name"  value="<?php echo $model['name']; ?>" type="text" maxlength="15" />
            </div>
        ...
        <fieldset>
            ...
            <div class="goods_desc_box form_group">
                <label>详细介绍</label>
                <script class="ueditor" id="container" name="intro"  type="text/plain"><?php echo $model['intro']; ?>
            </script>
