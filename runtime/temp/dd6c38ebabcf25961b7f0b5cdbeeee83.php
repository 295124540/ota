<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\xampp\htdocs\ota\public/../application/admin\view\house\add.html";i:1495088194;s:64:"D:\xampp\htdocs\ota\public/../application/admin\view\layout.html";i:1495096603;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
            ...
            <div class="col_side">
                <div class="menu_box" id="menuBar">
                    ...
                    <dl class="menu ">
                        ...
                        <dd class="menu_item "><a  href="/admin/house/getList">民宿客栈</a></dd>
                    </dl>
                    ...
                    <dl class="menu ">
                        ...
                        <dd class="menu_item "><a href="/admin/book/houseList">黄金书屋</a></dd>
                        <dd class="menu_item "><a href="#">心灵之书</a></dd>
                        <dd class="menu_item "><a href="#">书屋wifi</a></dd>
                        <dd class="menu_item "><a href="#">旅游资讯</a></dd>
                    </dl>
    ...
    <div class="title_tab">
        <ul class="tab_navs title_tab">
            <li class="tab_nav first js_top"><a href="/admin/house/getList" id="reloadTop">全部民宿</a></li>
...
<div class="main_bd">
    ...
    <fieldset>
        ...
        <div class="form_group">
            <label>基本价格</label><input  name="price" min="0"  type="number"  />
    ...
    <fieldset>
        ...
        <div class="form_group">
            <label>民宿规格</label>
            <!--<button class="btn btn_primary js-add-sku">新增</button>-->
            <div class="sku_box">
                <div class="sku_item">
                    <label>房型</label><input class="sku_input" name="sku_name[]"  type="text"  /> 
                    <label>预订价格</label><input class="sku_input" name="sku_price[]"  type="number"  /> 
                    <label>房间数</label><input class="sku_input" name="sku_stock[]"  type="number"  />   
                </div>
                <div class="sku_item">
                    <label>房型</label><input class="sku_input" name="sku_name[]"  type="text"  /> 
                    <label>预订价格</label><input class="sku_input" name="sku_price[]"  type="number"  /> 
